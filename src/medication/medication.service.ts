...
export class MedicationAnalysisService {
  ...
  public readonly defaultPrompt = 'give me the medication name and how to use it in just two lines,if its not a medicament image just print you should choose a medicament image please';
